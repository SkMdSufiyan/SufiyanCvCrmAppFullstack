                  ...
                  <Card style={{width: '18rem'}}>
                    <span>After submitting the form kindly wait for some time it may take some time to process</span>
                      <CardBody>
                          ...
                          <p><span>{servReqFormErrors.titleError} </span></p>
                          {/* <br /> */}
                          ...
                          <p><span>{servReqFormErrors.descriptionError} </span></p>
                          {/* <br /> */}
                          ...
                          <p><span>{servReqFormErrors.createdByError} </span></p>
                          {/* <br /> */}
                          ...
                          <p><span>{servReqFormErrors.createdDateError} </span></p>
                          {/* <br /> */}

...
const Home = () => {
  ...
  return (
    ...
    <p className='app-suggestion-p'><b style={{color : "blue"}}>The server of this application is deployed on a Render's free tier account</b>. Due to Render's <b style={{color : "blue"}}>"spinning down on idle"</b> issue, the server may take a little longer to start (when it is opened after a long time).</p>

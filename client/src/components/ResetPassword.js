...
// Function for making a PUT call for updating the password
  ...
  const handleNewCredChange = (e) => {
    setUserNewCredentials({...userNewCredentials, [e.target.name] : e.target.value});
        ...
        <Card style={{width: '18rem'}}>
            ...
            {isTokenValid && ! apiCallError && ! isResetPasswordSuccess ? (
              ...
              <div>
                ...
                <p><span>{userNewCredErrors.newPasswordError}</span></p>
                ...
                <p><span>{userNewCredErrors.confirmNewPasswordError}</span></p>

                  ...
                  <Card style={{width: '20rem'}}>
                    <span>After submitting the form kindly wait for some time it may take some time to process</span>
                      <CardBody>
                          ...
                          <p><span>{userFormErrors.emailError} </span></p>
                          ...
                          <p><span>{userFormErrors.firstNameError} </span></p>
                          ...
                          <p><span>{userFormErrors.lastNameError} </span></p>
                          ...
                          {userID ? (
                            ...
                            <div>
                                ...
                                <p><span>{userFormErrors.passwordError} </span></p>
                            </div>
                          )}
